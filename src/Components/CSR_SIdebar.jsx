...
export default function CSR_SIdebar() {
    return (
        <div>
            <div className="flex h-[100vh] flex-col justify-centere bg-black w-64">
                ...
                <div className="px-4 py-6">
                    <ul className="mt-6 space-y-1">
                        <li>
                            <Link to="/csr" className="block rounded-lg  px-4 py-2 text-sm font-medium text-gray-700">
                                Dashboard
                            </Link>
                        </li>
