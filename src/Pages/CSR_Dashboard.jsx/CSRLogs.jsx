...
import DataLogSuperAdmin from '../SuperAdminDashboard.jsx/DataLogSuperAdmin';
import ComplainLogSuperAdmin from '../SuperAdminDashboard.jsx/ComplainLogSuperAdmin';
import RedoSuperAdmin from '../SuperAdminDashboard.jsx/RedoSuperAdmin';
import NRSuperAdmin from '../SuperAdminDashboard.jsx/NRSuperAdmin';
import RenewalLogSuperAdmin from '../SuperAdminDashboard.jsx/RenealLogSuperAdmin';

export default function CSRLogs() {
    ...
    return (
        <div>
            <div className='flex h-[100vh] bg-black pt-0 mt-0'>
                {isSidebarOpen && (
                    <div className="sidebar"><CSR_SIdebar /></div>
                )}
