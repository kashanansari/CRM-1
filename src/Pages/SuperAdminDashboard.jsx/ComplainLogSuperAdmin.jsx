...
export default function ComplainLogSuperAdmin() {
                    ...
                    <div className='m-2 mt-0 p-2 bg-white'>
                        ...
                        <div className='flex grid lg:grid-cols-2 md:grid-cols-1'>
                            <div className=' flex flex-col justify-center'>
                                <div className='flex justify-center my-2'><p className='text-end md:text-start ' style={{ width: "40%" }}> Nature of Complain</p><select class={`input-field  ml-4 p-1  border ${inputValue.trim() !== '' ? 'bg-white' : 'bg-gray-200'}`} onChange={handleInputChange} style={{ width: "55%" }} aria-label=".form-select-lg example">
                                    <option value="1">N/R No Report </option>
                                    <option value="2">SMS Issue </option>
                                    <option value="3">Update Form</option>
                                    <option value="4">Web Track Issue </option>
                                    <option value="5">Wrong Location</option>
                                </select>
                                </div>
                                <div className='flex justify-center my-2'><p className='text-end md:text-start ' style={{ width: "40%" }}> Complain Id</p><input className='bg-gray-200  ml-4 p-1 ' style={{ width: "55%" }} /> </div>
                                <div className='flex justify-center my-2'><p className='text-end md:text-start ' style={{ width: "40%" }}> Customer Name</p><input className='bg-gray-200  ml-4 p-1 ' style={{ width: "55%" }} /> </div>
                                <div className='flex justify-center my-2'><p className='text-end md:text-start ' style={{ width: "40%" }}> Registration Number</p><input className='bg-gray-200  ml-4 p-1 ' style={{ width: "55%" }} /> </div>
                            </div >
