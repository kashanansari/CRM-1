                ...
                <button onClick={toggleSidebar} className='bg-black'><img src='data:image/png;base64,' className='h-8 w-8 bg-black' /></button>
                    <div className='flex grid lg:grid-cols-2 md:grid-cols-1'>
                        <div className=' flex flex-col mt-3 p-2'>
                            ...
                            <div className='flex  my-2'><p className='text-end md:text-start ' style={{ width: "40%" }}>Donor Id :</p><input className=' ml-3 custum_input p-1 ' /> </div>
                            <div className='flex  my-2'><p className='text-end md:text-start ' style={{ width: "40%" }}>Email</p><input className=' ml-3 custum_input p-1 ' /> </div>
                            <div className='flex  my-2'><p className='text-end md:text-start ' style={{ width: "40%" }}>Next of kin:</p><input className=' ml-3 custum_input p-1 ' /> </div>
                            <div className='flex  my-2'><p className='text-end md:text-start ' style={{ width: "40%" }}>Next of kin Number:</p><input className=' ml-3 custum_input p-1 ' /> </div>
                        </div >
                        <div className=' flex flex-col mt-3 p-2'>
